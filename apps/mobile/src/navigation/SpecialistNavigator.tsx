...
import { SpecialistProfileUpdateScreen } from '../screens/SpecialistProfileUpdateScreen';
import { SpecialistAccountScreen } from '../screens/SpecialistAccountScreen';
import { SpecialistAvailabilityScreen } from '../screens/SpecialistAvailabilityScreen';
import { SpecialistAppointmentDetailsScreen } from '../screens/SpecialistAppointmentDetailsScreen';
...
export type SpecialistStackParamList = {
  MainTabs: undefined;
...
const Stack = createNativeStackNavigator<SpecialistStackParamList>();
...
const TabNavigator = () => {
  ...
  const { data: appointments } = useQuery({
    queryKey: ['upcoming-count-specialist'],
    queryFn: async () => {
        try {
  ...
  const { data: unreadCount } = useQuery({
    queryKey: ['unread-messages-count-specialist'],
    queryFn: async () => {
        try {
...
export const SpecialistNavigator = () => {
  ...
  return (
    ...
    >
      ...
      <Stack.Screen name="AppointmentDetails" component={SpecialistAppointmentDetailsScreen} />
